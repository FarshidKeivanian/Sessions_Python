...
# Handling NaN in categorical columns 'Name' and 'Credit_Card_Number' by replacing with mode
...
# Dropping rows where 'Date_of_Birth' is still NaN
...
print("\n=== Step 4: Data After Handling NaN Values ===")
print(df_no_duplicates)
